...
- [duration](https://lubridate.tidyverse.org/reference/duration.md)s
...
- [period](https://lubridate.tidyverse.org/reference/period.md)s record
  the change in the clock time between two date-times. They are measured
  in human units: years, months, days, hours, minutes, and seconds.
