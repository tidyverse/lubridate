...
- e1:
  ...
  [POSIXct](https://lubridate.tidyverse.org/reference/posix_utils.md) or
...
- e2:
  ...
  [POSIXlt](https://rdrr.io/r/base/DateTimeClasses.html),
  [POSIXct](https://lubridate.tidyverse.org/reference/posix_utils.md) or
  [Date](https://lubridate.tidyverse.org/reference/date_utils.md). Note
  that one of e1 and e2 must be a period and the other a date-time
  object.
