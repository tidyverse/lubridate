...
[Period](https://lubridate.tidyverse.org/reference/Period-class.md) or
[`difftime()`](https://rdrr.io/r/base/difftime.html) object, length in
months or years is based on their most common lengths in seconds (see
