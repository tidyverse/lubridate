...
- truncated:
  ...
  [`ymd()`](https://lubridate.tidyverse.org/reference/ymd.md) family of
...
[`ymd()`](https://lubridate.tidyverse.org/reference/ymd.md), etc., will
drop into `fast_strptime()` instead of
