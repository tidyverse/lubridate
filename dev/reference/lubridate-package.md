...
A very flexible and user friendly parser is provided by
...
[`hms()`](https://lubridate.tidyverse.org/dev/reference/hms.md) and
...
[`instants()`](https://lubridate.tidyverse.org/dev/reference/is.instant.md))
...
[`now()`](https://lubridate.tidyverse.org/dev/reference/now.md) returns
the current system time as a POSIXct object.
[`today()`](https://lubridate.tidyverse.org/dev/reference/now.md)
returns the current system date. For convenience, 1970-01-01 00:00:00 is
saved to
[origin](https://lubridate.tidyverse.org/dev/reference/origin.md). This
...
[`tz()`](https://lubridate.tidyverse.org/dev/reference/tz.md), and
[`dst()`](https://lubridate.tidyverse.org/dev/reference/dst.md). Note:
the accessor functions are named after the singular form of an element.
They shouldn't be confused with the period helper functions that have
the plural form of the units as a name (e.g,
...
[lakers](https://lubridate.tidyverse.org/dev/reference/lakers.md) is a
data set that contains information about the Los Angeles Lakers
