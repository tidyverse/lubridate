...
test_that("is.instant/is.timepoint works as expected",{
	...
	expect_that(is.instant(as.POSIXct("2008-08-03 13:01:59")),
		is_true())
	expect_that(is.instant(as.POSIXlt("2008-08-03 13:01:59")), 
		is_true())
...
test_that("is.instant/is.timepoint handle vectors",{
	...
	expect_that(is.instant(c(as.POSIXct("2008-08-03 13:01:59"), 
		as.POSIXct("2008-08-03 13:01:59"))), is_true())
})


test_that("is.timespan works as expected",{
	expect_that(is.timespan(234), is_false())
	expect_that(is.timespan(as.POSIXct("2008-08-03 13:01:59")),
		is_false())
	expect_that(is.timespan(as.POSIXlt("2008-08-03 13:01:59")), 
		is_false())
...
test_that("is.POSIXt works as expected",{
	...
	expect_that(is.POSIXt(as.POSIXct("2008-08-03 13:01:59")),
		is_true())
	expect_that(is.POSIXt(as.POSIXlt("2008-08-03 13:01:59")), 
		is_true())
...
test_that("is.difftime/is.duration works as expected",{
	...
	expect_that(is.difftime(as.POSIXct("2008-08-03 13:01:59")),
		is_false())
	expect_that(is.difftime(as.POSIXlt("2008-08-03 13:01:59")), 
		is_false())
...
test_that("is.Date works as expected",{
	...
	expect_that(is.Date(as.POSIXct("2008-08-03 13:01:59")),
		is_false())
	expect_that(is.Date(as.POSIXlt("2008-08-03 13:01:59")), 
		is_false())
...
test_that("is.period works as expected",{
	...
	expect_that(is.period(as.POSIXct("2008-08-03 13:01:59")),
		is_false())
	expect_that(is.period(as.POSIXlt("2008-08-03 13:01:59")), 
		is_false())
...
test_that("is.interval works as expected",{
	...
	expect_that(is.interval(as.POSIXct("2008-08-03 13:01:59")),
		is_false())
	expect_that(is.interval(as.POSIXlt("2008-08-03 13:01:59")), 
		is_false())
...
test_that("is.interval handles vectors",{
	expect_that(is.interval(new_interval(
		c(as.POSIXct("2008-08-03 13:01:59"), 
		as.POSIXct("2009-08-03 13:01:59")),  
		as.POSIXct("2010-08-03 13:01:59"))), is_true())
})
