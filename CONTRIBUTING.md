...
This outlines how to propose a change to lubridate. For more detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("batpigandme/lubridate", fork = TRUE)`.
...
Code of Conduct](https://lubridate.tidyverse.org/CODE_OF_CONDUCT.md). By
