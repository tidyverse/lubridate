...
Thanks for using lubridate! Before filing an issue, there are a few
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/batpigandme/lubridate/issues/new).
...
requests](https://github.com/batpigandme/lubridate/issues) to make sure
