...
\begin{itemize}
  ...
  \item work with absolute vs. relative time by clarifying the differences between durations, periods and instances, Section~\ref{sec:types},
  
  \item parse dates automatically, Section~\ref{sec:parsing} and
\end{itemize}

Lubridate also provides other generally useful utility function, like creating pretty sequences of tick marks for graphs, as described in Section\ref{sec:utils}.
...
\section{Manipulating date-times} \label{sec:accessors}
