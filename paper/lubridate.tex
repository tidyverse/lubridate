...
There are two different but common ways of measuring time: an ``exact" way and a ``relative" way.  Failure to consider which you are using may result in unintentional errors. \pkg{lubridate} simplifies measuring time by explicitly specifying exact and relative operations.
