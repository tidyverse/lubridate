...
test_that("force_tz behaves consistently for the fall overlap",{
	...
	expect_that(force_tz(y, "") + hours(1), 
		equals(as.POSIXct("2010-11-07 02:30:05")))
	expect_that(force_tz(y, "") - hours(1), 
		equals(as.POSIXct("2010-11-07 00:30:05")))
...
test_that("addition handles daylight savings time for fall overlap", {
	x <- as.POSIXct("2010-11-07 00:00:00")
...
test_that("update rollovers perform correctly across the fall overlap",{
	poslt <- as.POSIXct("2010-11-07 01:59:59")			 
	expect_that(update(poslt, minutes = 121), equals(as.POSIXct("2010-11-07 03:01:59")))
	expect_that(update(poslt, minutes = 0), equals(as.POSIXct("2010-11-07 01:00:59")))
