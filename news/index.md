...
- [\#682](https://github.com/tidyverse/lubridate/issues/682#issuecomment-1635910435)
  ...
  [`quarter()`](https://lubridate.tidyverse.org/reference/quarter.md)
...
- [`as_datetime()`](https://lubridate.tidyverse.org/reference/as_date.md)
  accepts multiple formats in format argument, just like
  [`as_date()`](https://lubridate.tidyverse.org/reference/as_date.md)
  does.
...
- [\#941](https://github.com/tidyverse/lubridate/issues/941)
  [`format_ISO8601()`](https://lubridate.tidyverse.org/reference/format_ISO8601.md)
...
- [\#1044](https://github.com/tidyverse/lubridate/issues/1044) POSIXlt
  results returned by
  [`fast_strptime()`](https://lubridate.tidyverse.org/reference/parse_date_time.md)
  and
  [`parse_date_time2()`](https://lubridate.tidyverse.org/reference/parse_date_time.md)
...
- [`stamp()`](https://lubridate.tidyverse.org/reference/stamp.md) now
  correctly errors when no formats could be guessed.
...
- [\#914](https://github.com/tidyverse/lubridate/issues/914) New
  [`rollforward()`](https://lubridate.tidyverse.org/reference/rollbackward.md)
  function
...
- [\#630](https://github.com/tidyverse/lubridate/issues/630) New parsing
  functions [`ym()`](https://lubridate.tidyverse.org/reference/ymd.md)
  and [`my()`](https://lubridate.tidyverse.org/reference/ymd.md)
...
- New duration constructor
  [`dmonths()`](https://lubridate.tidyverse.org/reference/duration.md)
...
- [\#681](https://github.com/tidyverse/lubridate/issues/681) New
  constructors
  [`Date()`](https://lubridate.tidyverse.org/reference/date_utils.md)
  and
  [`POSIXct()`](https://lubridate.tidyverse.org/reference/posix_utils.md)
...
- [`tz()`](https://lubridate.tidyverse.org/reference/tz.md) always
...
- [\#570](https://github.com/tidyverse/lubridate/issues/570),
  ...
  [`date()`](https://lubridate.tidyverse.org/reference/date.md) when
...
- [`period()`](https://lubridate.tidyverse.org/reference/period.md) now
  works with unit = “weeks”
